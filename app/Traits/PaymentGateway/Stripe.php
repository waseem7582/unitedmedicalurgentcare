                ...
                'line_items'        => [
                    [
                        'price_data'    => [
                            'product_data'      => [
                                'name'          => "Add Money",
                                'description'   => "Payment Currency " . $output['currency']->currency_code,
                                'images'        => [
                                    [
                                        get_logo()
                                    ]
                            ...
                            'unit_amount_decimal'   => get_amount($output['amount']->total_payable_amount, null, 2) * 100, // as per stripe policy,
