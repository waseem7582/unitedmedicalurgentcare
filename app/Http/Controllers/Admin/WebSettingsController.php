...
class WebSettingsController extends Controller
{
    ...
    public function basicSettingsUpdateHospital(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'hospital_base_color'        => 'required|string',
            'hospital_site_name'         => 'required|string',
            'hospital_site_title'        => 'required|string',
            'hospital_secondary_color'   => 'required|string',
        ]);
        $validated = $validator->validate();
    ...
    public function imageAssetsUpdate(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'hospital_site_logo'             => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
            'hospital_site_logo_dark'        => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
            'hospital_site_fav'              => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
            'hospital_site_fav_dark'         => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
