...
class SupportTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        $support_tickets = UserSupportTicket::authTicketsHospital()->orderByDesc("id")->paginate(10);
        return view('hospital.sections.support-ticket.index', compact('page_title', 'support_tickets'));
    }
    ...
    public function create()
    {
        ...
        return view('hospital.sections.support-ticket.create', compact('page_title', 'hospital'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hospitals.support.ticket.index')->with(['success' => [__('Support ticket created successfully')]]);
    }
    ...
    public function conversation($encrypt_id)
    {
        ...
        $page_title = "";
        return view('hospital.sections.support-ticket.conversation', compact('page_title', 'support_ticket'));
    }
