        ...
        <form class="account-form" action="{{ setRoute('admin.password.update') }}" method="POST">
            ...
            <div class="form-group">
                <div class="form-group" id="show_hide_password">
                    <input type="password" title="{{ __("Enter new password") }}" required name="password">
                    <button type="button" class="show-pass"><i class="fa fa-eye-slash" aria-hidden="true"></i></button>
                    <label>{{ __("New Password") }}</label>
                </div>
            </div>
            <div class="form-group" id="show_hide_password">
                <input type="password" title="{{ __("Enter Confirm password") }}" required name="password_confirmation">
                <button type="button" class="show-pass"><i class="fa fa-eye-slash" aria-hidden="true"></i></button>
