    ...
    <div class="account-wrapper">
        ...
        <form class="account-form" action="{{ setRoute('admin.login.submit') }}" method="POST">
            ...
            <div class="form-group">
                <input type="text" class="@error('email') is-invalid @enderror" title="{{ __("Enter Username") }}" required name="email" value="{{ old('email') }}" autofocus>
            ...
            <div class="form-group show_hide_password">
                <input type="password" title="{{ __("Enter password") }}" required name="password">
