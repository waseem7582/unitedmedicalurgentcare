...
@section('breadcrumb')
    ...
    ], 'active' => __("Hospital Requirements Section")])
@endsection
...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#whyChoiceUs-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.hospital-requirements-section.add')

    @include('admin.components.modals.site-section.hospital-requirements-section.edit')
@endsection
@push('script')
    ...
    <script>
        ...
        openModalWhenError("whyChoiceUs-add","#whyChoiceUs-add");
        openModalWhenError("whyChoiceUs-edit","#whyChoiceUs-edit");
        ...
        $('.edit-modal-button').click(function(){
            ...
            var editModal = $("#whyChoiceUs-edit");
            ...
            openModalBySelector("#whyChoiceUs-edit");
        });
