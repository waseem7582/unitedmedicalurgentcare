...
@section('breadcrumb')
    @include('admin.components.breadcrumb',['breadcrumbs' => [
        ...
        [
            'name'  => __("Blog Section"),
            'url'   => setRoute('admin.setup.sections.section','web-blog-section')
        ]

    ], 'active' => __("Blog Edit Page")])
@endsection
@section('content')
...
<div class="custom-card">
    ...
    <div class="card-body">
        <form class="card-form" action="{{ setRoute('admin.setup.sections.blog.update',$blog->slug) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row justify-content-center mb-10-none">
                <div class="col-xl-4 col-lg-4 form-group">
                    @include('admin.components.form.input-file',[
                        ...
                        'old_files'         => old("old_image",$blog->data->image),
                    ])
                </div>
