...
@section('content')
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $item->code . 'section_title',
                                                    $data->value->language->$lang_code->section_title ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#hospital-feature-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add hospital-feature') }}</a>
                </div>
            </div>
                        ...
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>
                                    ...
                                    <a href="{{ setRoute('admin.setup.sections.feature.details', [$item->id]) }}"
                                        class="btn btn--base add-page-button">
    ...
    @include('admin.components.modals.site-section.hospital-features-section.add')
    @include('admin.components.modals.site-section.hospital-features-section.edit')
@endsection
...
@push('script')
    ...
    <script>
        openModalWhenError("hospital-feature-add", "#hospital-feature-add");
        openModalWhenError("hospital-feature-edit", "#hospital-feature-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#hospital-feature-edit");
            ...
            fileHolderPreviewReInit("#hospital-feature-edit input[name=image_edit]");
            openModalBySelector("#hospital-feature-edit");
