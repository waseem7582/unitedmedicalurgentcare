...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#work-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.how-its-work-section.add')
    @include('admin.components.modals.site-section.how-its-work-section.edit')
...
@push('script')
    ...
    <script>
        openModalWhenError("work-item-add","#work-item-add");
        openModalWhenError("work-item-edit","#work-item-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            openModalBySelector("#work-item-edit");
