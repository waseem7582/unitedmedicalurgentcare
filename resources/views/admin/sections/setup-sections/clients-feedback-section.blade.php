...
@section('content')
    ...
    @include('admin.components.modals.site-section.feedBack-section.add')
    @include('admin.components.modals.site-section.feedBack-section.edit')
...
@push('script')
    ...
    <script>
        ...
        $(".delete-modal-button").click(function(){
            ...
            var message     = `{{ __("Are you sure to") }} <strong>delete</strong> item?`;
