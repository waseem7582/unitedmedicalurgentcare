...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#features-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.features-section.add')
    @include('admin.components.modals.site-section.features-section.edit')
...
@push('script')
    ...
    <script>
        openModalWhenError("features-item-add","#features-item-add");
        openModalWhenError("features-item-edit","#features-item-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#features-item-edit");
            ...
            $.each(languages,function(index,item) {
                ...
                editModal.find("input[name="+item.code+"_details_edit]").val(oldData.language[item.code]?.details);
            });
            openModalBySelector("#features-item-edit");
