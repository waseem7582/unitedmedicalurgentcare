        ...
        <div class="support-card-wrapper">
            <div class="card-header">
                <div class="card-header-user-area">
                    <img class="avatar" src="{{ get_image($support_ticket->creator->image,"user-profile") }}" alt="client">
                    <div class="card-header-user-content">
                        @if ($support_ticket->user_id != null )
                        <h6 class="title">{{ $support_ticket->creator->fullname }}</h6>
                        @else
                        <h6 class="title">{{ $support_ticket->creator->hospital_name }}</h6>
                        @endif
