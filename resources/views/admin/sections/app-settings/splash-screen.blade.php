                    ...
                    <div class="col-xl-4">
                        <div class="row">
                            <div class="col-xl-6 col-lg-2 col-md-3 col-sm-4 form-group">
                                @include('admin.components.form.input-file', [
                                    'label' =>
                                        __('Image (Hospital)') . ': <span class="text--danger">(414*896)</span>',
                                    'class' => 'file-holder',
                                    'name' => 'hospital_image',
                                    'old_files_path' => files_asset_path('splash-images'),
                                    'old_files' => $app_settings->hospital_splash_screen_image,
                                ])
                            </div>
                            <div class="col-xl-6 col-lg-10 col-md-9 col-sm-8">
                                <div class="form-group">
                                    @include('admin.components.form.input', [
                                        'label' => __('App Version* (Hospital)'),
                                        'name' => 'hospital_version',
                                        'attribute' => 'data-limit=15',
                                        'value' => old('hospital_version', $app_settings->hospital_version),
                                        'placeholder' => __('Write Here..'),
                                    ])
                                </div>
                            </div>
