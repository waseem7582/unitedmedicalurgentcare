        ...
        <div class="dashboard-area">
            <div class="dashboard-item-area">
                <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-15">
                            <a href="{{ setRoute('admin.app.settings.onboard.screens',"HOSPITAL") }}" class="d-block">
                                <div class="dashbord-item border">
                                    <div class="dashboard-content">
                                        <div class="left">
                                            <h6 class="title">{{ __("Active Onboards (HOSPITAL)") }}</h6>
                                            <div class="user-info">
                                                <h2 class="user-count">{{ $onboard_screens_hospital }}</h2>
                                            </div>
                                        </div>
                                        <div class="right">
