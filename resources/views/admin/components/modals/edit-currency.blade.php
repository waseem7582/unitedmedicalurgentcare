            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.currency.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-10-none">
                        ...
                        <div class="col-xl-12 col-lg-12 form-group">
                            <input type="hidden" name="currency_type" value="{{ old('currency_type', 'FIAT') }}">
                        ...
                        <div class="col-xl-12 col-lg-12 form-group">
                            <input type="hidden" name="currency_role" value="{{ old('currency_role', 'both') }}">

                        </div>
                        <div class="col-xl-12 col-lg-12 form-group">
                            <input type="hidden" name="currency_option" value="{{ old('currency_option', 0) }}">
