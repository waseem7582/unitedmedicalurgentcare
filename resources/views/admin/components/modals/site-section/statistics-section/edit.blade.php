                                ...
                                <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="modal-{{ $item->name }}" role="tabpanel" aria-labelledby="modal-{{$item->name}}-tab">
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            ...
                                            'name'      => $lang_code . "_item_counter_value_edit",
                                            'value'     => old($lang_code . "_item_counter_value",$data->value->language->$lang_code->item_counter_value ?? "")
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            ...
                                            'value'     => old($lang_code . "_item_description",$data->value->language->$lang_code->item_description ?? "")
                                        ])
                                    </div>
                                </div>
                            @endforeach
