@php
    $oldSchedules = old('from_time', []); // Check if there are old schedule values
@endphp

@if (!empty($oldSchedules))
    @foreach ($oldSchedules as $index => $oldFromTime)
