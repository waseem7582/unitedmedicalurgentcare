                ...
                <div class=" col-xl-6 col-lg-8 col-md-10 col-sm-12">
                    <div class="verification-otp-area">
                        <div class="account-wrapper otp-verification">
                            ...
                            <form action="{{ setRoute('hospitals.authorize.mail.verify', $token) }}" class="account-form"
                                method="POST">
                                @csrf
            ...
            var x = setInterval(function() { // Get today's date and time
                ...
                if (distance < 0 || second < 2) {
                    ...
                    document.querySelector(".time-area").innerHTML =
                        `Didn't get the code? <a href="{{ route('hospitals.authorize.mail.resend', $token) }}" onclick="resendOtp()" class="text--danger">Resend</a>`;
                }
