                        ...
                        <div class="account-wrapper otp-verification">
                            <div class="account-logo text-center">
                                <a href="{{ setRoute('frontend.index') }}" class="site-logo">
                                    <img src="{{ get_logo_hospital($basic_settings) }}" alt="logo">
                                </a>
                            </div>
                            ...
                            <form action="{{ setRoute('hospitals.password.forgot.verify.code',$token) }}" class="account-form" method="POST">
                                @csrf
                                <div class="row ml-b-20">
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <div class="account-item">
                                            <label>{{ __("Back To") }} <a href="{{ setRoute('frontend.index') }}" class="account-control-btn">{{ __("Home Page") }}</a></label>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script>
    ...
    var resendCodeLink = "{{ setRoute('hospitals.password.forgot.resend.code',$token) }}";

    function resetTime (second = 59) {
