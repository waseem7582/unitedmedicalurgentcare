...
class DBHelper {
    ...
    public function migrate() {
        ...
        // self::execute('php "' . base_path('artisan') . '" migrate:fresh --seed');
        // self::execute('php "' . base_path('artisan') . '" migrate');
        // self::execute('php "' . base_path('artisan') . '" passport:install --force');
